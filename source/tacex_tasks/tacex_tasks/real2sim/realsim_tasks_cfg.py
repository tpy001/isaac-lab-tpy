...
from isaaclab_tasks.direct.factory.factory_tasks_cfg import Hole8mm,Peg8mm
...
class RealSimPegInsert(PegInsert, RealSimTask):
    ...
    success_threshold: float = 0.2 # 插入的长度超过总长度的 80% 就算成功
    ...
    fixed_asset: ArticulationCfg = ArticulationCfg(
        ...
        # ),
        init_state=ArticulationCfg.InitialStateCfg(
            pos=(-0.07, -0.42, 0.2), rot=(1.0, 0.0, 0.0, 0.0), joint_pos={}, joint_vel={}
        ),
        actuators={},
    )
    held_asset: ArticulationCfg = ArticulationCfg(
        ...
        init_state=ArticulationCfg.InitialStateCfg(
            pos=(-0.07, -0.42, 0.6), rot=(1.0, 0.0, 0.0, 0.0), joint_pos={}, joint_vel={}
        ),
        actuators={},
    )
